...
Information associated with the SignalFx Gateway (formerly known as the SignalFx Metric Proxy) can be found [here](https://github.com/signalfx/integrations/tree/release/metricproxy). The relevant code for the project can be found [here](https://github.com/signalfx/metricproxy).
